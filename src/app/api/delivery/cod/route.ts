    ...
    try {
        ...
        if (orderDoc.exists) {
            await orderRef.update({
                ...
                ...(reviewStatus === 'rejected' ? { codSettled: false, paymentStatus: 'QR Rejected — Needs Resettlement' } : {}),
            });
        }
