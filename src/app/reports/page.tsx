...
export default function ReportsPage() {
    ...
    const stats = useMemo(() => {
        ...
        return [
            ...
            { label: 'Total Orders', value: totalOrders.toLocaleString(), subtitle: todayOrders > 0 ? `${todayOrders} today` : 'No orders today', icon: ShoppingBag, iconBg: 'linear-gradient(135deg, #F4511E, #D84315)' },
                                ...
                                <AreaChart data={revenueData}>
                                    <defs>
                                        <linearGradient id="revenueGrad" x1="0" y1="0" x2="0" y2="1">
                                            <stop offset="5%" stopColor="#F4511E" stopOpacity={0.25} />
                                    ...
                                    <Area type="monotone" dataKey="revenue" stroke="#F4511E" strokeWidth={2.5} fill="url(#revenueGrad)" dot={{ fill: '#F4511E', strokeWidth: 0, r: 3 }} activeDot={{ r: 5, fill: '#F4511E', stroke: 'white', strokeWidth: 2 }} />
                                </AreaChart>
                            </ResponsiveContainer>
                        </div>
                    </motion.div>
                        ...
                        <div style={{ height: 320 }}>
                            <ResponsiveContainer width="100%" height="100%">
                                <BarChart data={monthlyData} barGap={4}>
                                    ...
                                    <Bar yAxisId="left" dataKey="revenue" name="Revenue" fill="#F4511E" radius={[6, 6, 0, 0]} />
            ...
            <div style={{ marginBottom: 40 }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                        <div style={{ width: 36, height: 36, borderRadius: 10, background: 'linear-gradient(135deg, #F4511E, #D84315)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', boxShadow: 'var(--shadow-sm)' }}>
                            <Award size={18} />
                        </div>
