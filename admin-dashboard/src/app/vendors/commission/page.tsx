                                    ...
                                    <tr key={v.vendorId}>
                                        ...
                                        <td style={{ textAlign: 'center' }}>
                                            {editingVendor === v.vendorId ? (
                                                ...
                                                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
                                                    <button onClick={() => handleEdit(v)} style={{ width: 30, height: 30, borderRadius: 8, background: 'rgba(244,81,30,0.1)', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' }}><Edit3 size={14} color="#F4511E" /></button>
