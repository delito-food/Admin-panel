                            ...
                            return (
                                <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                                    <div style={{ fontSize: '0.8rem', color: 'var(--foreground-secondary)', padding: '0 4px', fontWeight: 500 }}>
                                        {allQrOrders.length} QR payment{allQrOrders.length > 1 ? 's' : ''} pending verification —
                                        these amounts are <strong style={{ color: '#F59E0B' }}>counted as unsettled</strong> until you approve them.
                                        Verify if the QR payment was received in your bank/UPI, then click Verified.
                                    </div>
